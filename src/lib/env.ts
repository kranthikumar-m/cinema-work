...
export const env = {
  ...
  OMDB_API_KEY: getOptionalEnvVar("OMDB_API_KEY"),
  SPOTIFY_CLIENT_ID: getOptionalEnvVar("SPOTIFY_CLIENT_ID"),
  SPOTIFY_CLIENT_SECRET: getOptionalEnvVar("SPOTIFY_CLIENT_SECRET"),
  GENIUS_ACCESS_TOKEN: getOptionalEnvVar("GENIUS_ACCESS_TOKEN"),
