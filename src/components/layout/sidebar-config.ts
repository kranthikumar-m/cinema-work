...
export const APP_SIDEBAR_DESKTOP_WIDTH_CLASS = "lg:w-[208px]";
export const APP_SIDEBAR_CONTENT_OFFSET_CLASS = "lg:pl-[208px]";
export const APP_SIDEBAR_DRAWER_WIDTH_CLASS = "w-[208px]";
